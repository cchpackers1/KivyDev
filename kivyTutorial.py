...
class ChatPage(GridLayout):
    ...
    def adjust_fields(self, *_):
      ...
      #Note: simply calling self.history.update_chat_history_layout() doesn't work for us here for some reason. 
      #Scheduling it, however, does: Clock.schedule_once(self.history.update_chat_history_layout, 0.01)
      Clock.schedule_once(self.history.update_chat_history, 0.01)
